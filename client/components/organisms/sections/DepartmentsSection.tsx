  ...
  return (
    <section className="w-full py-20 px-4 bg-gradient-to-b from-white via-cod-gray-50/50 to-white dark:from-cod-gray-950 dark:via-cod-gray-900/50 dark:to-cod-gray-950 relative overflow-hidden transition-colors duration-300" aria-labelledby="departments-heading">
      ...
      <div className="absolute inset-0 opacity-5 dark:opacity-10 transition-opacity duration-300">
        <div className="absolute top-20 left-10 w-32 h-32 border border-blue-600 dark:border-blue-400 rounded-full transition-colors duration-300"></div>
        <div className="absolute bottom-20 right-10 w-24 h-24 border border-blue-600 dark:border-blue-400 rounded-full transition-colors duration-300"></div>
        <div className="absolute top-1/2 left-1/4 w-16 h-16 border border-blue-600 dark:border-blue-400 rounded-full transition-colors duration-300"></div>
      </div>
      
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 bg-blue-50 dark:bg-blue-950/30 text-blue-600 dark:text-blue-400 px-4 py-2 rounded-full text-sm font-medium mb-6 transition-colors duration-300">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {DEPARTMENTS_DATA.map((dept) => (
            ...
            >
              <div className="mb-6">
                <div className="w-16 h-16 bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-950/30 dark:to-blue-900/30 rounded-2xl flex items-center justify-center transition-colors duration-300">
                  <Image
                    src={dept.icon}
                    alt=""
                    width={40}
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-2 text-sm font-medium text-blue-600 dark:text-blue-400 group-hover:text-blue-700 dark:group-hover:text-blue-300 transition-colors duration-300">
