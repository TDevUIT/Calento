      ...
      <div className="mx-auto max-w-4xl">
        ...
        >
          <div className="inline-flex items-center gap-2 rounded-full border border-blue-200 bg-blue-50 px-4 py-1.5 text-sm font-medium text-blue-700 dark:border-blue-900/50 dark:bg-blue-950/50 dark:text-blue-300">
            <svg aria-hidden="true" className="h-4 w-4 animate-pulse" fill="currentColor" viewBox="0 0 20 20">
        ...
        >
          ...
          >
            ...
            <svg aria-hidden="true" className="ml-2 h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      >
        ...
        <div className='hidden lg:block z-50 absolute -top-40 -left-10'>
          <div className="relative">
            <Image src="/images/dashed-arrow-icon.png" alt="" aria-hidden="true" className="-rotate-[100deg]" height={132} width={132} />
        ...
        <div className='hidden lg:block z-50 absolute -right-28 -bottom-20'>
          <div className="relative">
            <Image src="/images/dashed-arrow-icon.png" alt="" aria-hidden="true" className="rotate-90" height={132} width={132} />
      ...
      >
        <div className="text-center mb-4">
          ...
          <p className="text-lg text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">
            Join teams worldwide who trust Calento to streamline their scheduling
          </p>
        </div>
      </motion.div>
