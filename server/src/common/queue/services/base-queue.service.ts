...
export abstract class BaseQueueService<T = any> implements OnModuleDestroy {
    ...
    const jobOptions: JobsOptions = {
      ...
      removeOnComplete:
        options?.removeOnComplete !== undefined
          ...
          : 100,
      removeOnFail:
        options?.removeOnFail !== undefined ? options.removeOnFail : 500,
      jobId: options?.jobId,
    };
      ...
      opts: {
        ...
        removeOnComplete:
          job.opts?.removeOnComplete !== undefined
            ...
            : 100,
        removeOnFail:
          job.opts?.removeOnFail !== undefined ? job.opts.removeOnFail : 500,
  ...
  async getJobs(status: JobStatus, start = 0, end = 10): Promise<Job<T>[]> {
