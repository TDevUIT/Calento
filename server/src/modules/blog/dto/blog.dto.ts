import { IsString, IsOptional, IsEnum, IsBoolean, IsNumber, IsISO8601, IsNotEmpty, MaxLength, MinLength, IsUrl, IsArray } from 'class-validator';
...
export class CreateBlogPostDto {
    ...
    @ApiPropertyOptional({
        ...
        example: 'Discover how AI-powered scheduling can boost your productivity...',
        maxLength: 500
    })
    @IsString()
    @IsOptional()
