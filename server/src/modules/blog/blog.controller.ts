...
export class BlogController {
    ...
    @ApiResponse({ status: 201, description: 'Blog post created successfully', type: BlogPostResponseDto })
    ...
    @ApiResponse({ status: 200, description: 'Blog post updated successfully', type: BlogPostResponseDto })
    ...
    @ApiResponse({ status: 200, description: 'Blog post found', type: BlogPostResponseDto })
    @ApiResponse({ status: 404, description: 'Blog post not found' })
